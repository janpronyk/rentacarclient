                ...
                <form class="w-full max-w-md" @submit.prevent="saveUser">
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            id="firstname" type="text" name="name" v-model="name">
                        </div>
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-grey" 
                            id="lastname" type="text" name="surname" v-model="surname">
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-grey" 
                            id="password" type="password" name="password" v-model="password_confirm">
                        </div>
                    </div>
                    ...
                    <div class="flex justify-center">
                     ...
                     <div class="flex flex-column justify-center mt-5">
                         <p class="block">Back to 
                            <router-link 
                                :to="{ name: 'Login'}">
                                Login.
                            </router-link>
...
export default {
    ...
    methods: {
        saveUser() {
            ...
            user.append('password_confirmation', this.password_confirm)
